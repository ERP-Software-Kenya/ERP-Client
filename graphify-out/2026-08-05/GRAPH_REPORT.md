...
## Corpus Check
- 160 files · ~122,559 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1392 nodes · 2788 edges · 89 communities (79 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e9fc46ff`
...
- `SkeletonBox()` --calls--> `cn()`  [EXTRACTED]
  renderer/src/components/ProductDetailView.tsx → renderer/src/lib/utils.ts
- `createWindow()` --calls--> `initAutoUpdater()`  [EXTRACTED]
  src/main/index.ts → src/main/auto-updater.ts
- `SessionRoute()` --calls--> `useAuth()`  [EXTRACTED]
  renderer/src/App.tsx → renderer/src/context/AuthContext.tsx
- `WarehouseDashboard()` --references--> `Inventory`  [EXTRACTED]
  renderer/src/pages/dashboards/WarehouseDashboard.tsx → renderer/src/api.ts
- `InventoryDetailPage()` --references--> `Inventory`  [EXTRACTED]
  renderer/src/pages/InventoryDetail.tsx → renderer/src/api.ts
...
Cohesion: 0.21
Nodes (8): Sidebar(), Textarea, TextareaProps, Tooltip(), ALL_ITEMS, ModuleGroup, ModuleItem, MODULES
...
### Community 10 - "get"
Cohesion: 0.06
Nodes (62): useCancelStockTransfer(), useLinkProductSupplier(), useNextSku(), useProductLog(), useProductSuppliers(), useStockMovement(), useUnlinkProductSupplier(), useUpdateProductSupplier() (+54 more)
...
Cohesion: 0.22
Nodes (13): useProductImages(), useProductLogsByProduct(), actionBadgeClass(), actionDotClass(), fmtCurrency(), fmtDate(), fmtTimeAgo(), formatAction() (+5 more)
...
### Community 30 - "api.ts"
Cohesion: 0.05
Nodes (61): billsBase, customersBase, Expenses, inventoryBase, Invoices, ItemReturns, Notifications, Orders (+53 more)

### Community 31 - "FormDrawer.tsx"
Cohesion: 0.10
Nodes (38): Organizations, Suppliers, useCategoryParents(), ConfirmDialog(), ConfirmDialogProps, Column, DataTable(), DataTableProps (+30 more)
...
Cohesion: 0.24
Nodes (9): Categories, ImageLightbox(), ImageLightboxProps, FieldValue(), formatScalar(), isImageUrl(), NestedObject(), Props (+1 more)
...
Cohesion: 0.27
Nodes (8): ViewDrawer(), useDebounce(), BillsPage(), EMPTY_FORM, FormState, money(), partyLabel(), STATUS_FILTERS
...
Cohesion: 0.17
Nodes (17): ORG_ROLES, ListResource, ResourceSelect(), ResourceSelectProps, SelectContent, SelectItem, SelectTrigger, EMPTY_FORM (+9 more)
...
Cohesion: 0.05
Nodes (81): ActivityLogs, AdvancedIdLookup(), AdvancedIdLookupProps, LoginVisualPanel(), FormSection(), RecentIdPicker(), RecentIdPickerProps, RecentRecords() (+73 more)
...
Cohesion: 0.17
Nodes (6): PendingImg, Step, STEP_LABELS, UNITS, WizardProps, Product

### Community 51 - "Users.tsx"
Cohesion: 0.15
Nodes (16): ClerkUsers, AssignOrgDrawer(), Props, EMPTY, InviteUserDrawer(), Props, PRESET_ROLES, Props (+8 more)

### Community 52 - "UnpublishedStock.tsx"
Cohesion: 0.12
Nodes (19): useAddUnpublishedStock(), usePublishUnpublishedStock(), useUnpublishedStock(), useUnpublishedStockList(), useUnpublishedStockMovements(), GuideModal(), GuideModalProps, GuideStep (+11 more)
...
Cohesion: 0.16
Nodes (13): RowActionsMenuProps, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator, canMarkOrdered() (+5 more)
...
Cohesion: 0.50
Nodes (4): Props, ROLE_COLORS, roleColor(), UserRolePills()
...
### Community 64 - "cn"
Cohesion: 0.20
Nodes (14): BaseProps, FilterDropdown(), FilterDropdownProps, FilterOption, groupOptions(), MultiProps, OptionContent(), SearchBox() (+6 more)
...
Cohesion: 0.12
Nodes (19): Inventory, Locations, Products, StockTransfers, useCompleteStockTransfer(), useInventoryLowStock(), useInventoryValuation(), formatValuation() (+11 more)

### Community 70 - "CategoryDetailModal.tsx"
Cohesion: 0.23
Nodes (8): CategoryDetailModal(), formatDate(), Props, DialogContent, DialogFooter(), DialogHeader(), DialogTitle, Category
...
Cohesion: 0.13
Nodes (22): useProductLogsByInventory(), useStockMovementsByInventory(), useStockOperation(), useAutoSelectFirst(), formatEntityLabel(), truncateId(), EMPTY_META, EMPTY_OP (+14 more)
...
Cohesion: 0.20
Nodes (7): Bills, PaymentTransactions, PurchaseOrders, canVerify(), PurchaseOrderReceive(), STATUS_CONFIG, PurchaseOrderStatus
...
Cohesion: 0.19
Nodes (10): SessionRoute(), AuthBootPhase, AuthBootScreen(), ORDER, Props, STEPS, stepState(), ProtectedRoute() (+2 more)

### Community 80 - "Locations.tsx"
Cohesion: 0.23
Nodes (12): useListCities(), useListCountries(), useListStates(), useRemoveLocationImage(), useUploadLocationImage(), SingleImageUploader(), EMPTY_FORM, FormState (+4 more)
...
## Knowledge Gaps
- **683 isolated node(s):** `name`, `description`, `type`, `main`, `dev` (+678 more)
...
- **Why does `cn()` connect `cn` to `utils.ts`, `ErrorState.tsx`, `CategoryDetailModal.tsx`, `get`, `ItemReturns.tsx`, `ProductDetailView.tsx`, `button.tsx`, `ProductOnboardingWizard.tsx`, `Users.tsx`, `PurchaseOrderDetail.tsx`, `UserRolePills.tsx`, `FormDrawer.tsx`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `Button` connect `button.tsx` to `Products.tsx`, `ErrorState.tsx`, `Inventory.tsx`, `CategoryDetailModal.tsx`, `Bills.tsx`, `formatEntityLabel`, `ItemReturns.tsx`, `get`, `BillDetail.tsx`, `ProductDetailView.tsx`, `Locations.tsx`, `ProductOnboardingWizard.tsx`, `Users.tsx`, `UnpublishedStock.tsx`, `PurchaseOrderDetail.tsx`, `FormDrawer.tsx`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `useAuth` to `ThemeContext.tsx`, `App.tsx`, `button.tsx`, `Users.tsx`, `AuthContext.tsx`?**
