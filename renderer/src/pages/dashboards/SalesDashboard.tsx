    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          value={String(DEMO_TOTAL_ORDERS)}
          icon={ClipboardList}
        />
        <StatCard
          label="Total Invoices (demo)"
          value={String(DEMO_TOTAL_INVOICES)}
          icon={Receipt}
        />
        <StatCard
      ...
      <div className="p-4 bg-card border border-border rounded-xl shadow-sm text-center text-sm text-muted-foreground">
        Orders/Invoices totals and the trend chart above are demo data, pending
        the deferred Orders/Invoices list endpoints (plan Tasks 2–3). Customers
        also has no list/search endpoint yet on the backend, so Active Customers
