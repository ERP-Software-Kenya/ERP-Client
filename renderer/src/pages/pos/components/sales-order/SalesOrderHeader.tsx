...
export function SalesOrderHeader({
  ...
  return (
    <header className="flex flex-shrink-0 flex-wrap items-center justify-between gap-3 border-b border-border bg-card px-5 py-3">
      <div className="flex min-w-0 flex-wrap items-center gap-3">
        <div>
          <h1 className="text-lg font-semibold text-foreground">New Sales Order</h1>
          <p className="text-xs text-muted-foreground">
            {store?.name ?? "Select store"} · <span className="font-mono">{saleRef}</span>
          </p>
        </div>
