...
describe('canAccessPage', () => {
  ...
  it('inherits debtors and creditors-ac access from customers when unconfigured', () => {
    ...
    expect(canAccessPage(['branch_manager'], 'creditors-ac', configWithCustomers)).toBe(true);
    expect(canAccessPage(['driver'], 'creditors-ac', configWithCustomers)).toBe(false);
  });

  it('inherits purchase-creditors and debtors-ac access from suppliers when unconfigured', () => {
    ...
    expect(canAccessPage(['branch_manager'], 'debtors-ac', configWithSuppliers)).toBe(true);
    expect(canAccessPage(['driver'], 'debtors-ac', configWithSuppliers)).toBe(false);
  });
