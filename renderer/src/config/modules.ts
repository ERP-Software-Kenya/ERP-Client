...
export const MODULES: ModuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'debtors', title: 'Debtors', path: '/sales/debtors', icon: UserCheck },
      { key: 'creditors', title: 'Credit Ledger', path: '/sales/creditors', icon: CreditCard },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'purchase-creditors', title: 'Creditors', path: '/purchase/creditors', icon: CreditCard },
